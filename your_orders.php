							...
							?>
												<tr>	
														 <td data-column="Item"> <?php echo $row['title']; ?></td>
														  ...
														  <td data-column="price">SDG <?php echo $row['price']; ?></td>
														   ...
														   <?php 
																			...
																			{
																			?>
																			<button type="button" class="btn btn-info" style="font-weight:bold;">إرسال</button>
																		   <?php 
																			  }
																			   if($status=="in process")
																			 { ?>
																				<button type="button" class="btn btn-warning"><span class="fa fa-cog fa-spin"  aria-hidden="true" ></span>على الطريق!</button>
																			<?php
																				}
																			if($status=="closed")
																				{
																			?>
																			 <button type="button" class="btn btn-success" ><span  class="fa fa-check-circle" aria-hidden="true">تم التوصيل</button> 
																			<?php 
																			} 
																			?>
																			<?php
														  ...
														  <td data-column="Date"> <?php echo $row['date']; ?></td>
														   <td data-column="Action"> <a href="delete_orders.php?order_del=<?php echo $row['o_id'];?>" onclick="return confirm('هل انت متاكدد من انك تريد الغاء طلبك ؟');" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a> 
															</td>
