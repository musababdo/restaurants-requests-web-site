...
<div class="container">
  <div class="info">
    <h1>الاداره </h1><span>تسجيل دخول</span>
  </div>
</div>
<div class="form">
  ...
  <form class="register-form" action="index.php" method="post">
    <input type="text" placeholder="اسم المستخدم" name="cr_user"/>
    <input type="text" placeholder="البريد الالكتروني"  name="cr_email"/>
	 <input type="password" placeholder="كلمه المرور"  name="cr_pass"/>
	  <input type="password" placeholder="تاكيدد كلمه المرور"  name="cr_cpass"/>
	  <input type="password" placeholder="كود فريد"  name="code"/>
   <input type="submit"  name="submit1" value="انشاء حساب" />
    <p class="message">لديك حساب ؟<a href="#">تسجيل دخول</a></p>
  </form>
  <span>username:admin</span>&nbsp;<span>password:1234</span>
  <span style="color:red;"><?php echo $message; ?></span>
   <span style="color:green;"><?php echo $success; ?></span>
  <form class="login-form" action="index.php" method="post">
    <input type="text" placeholder="اسم المستخددم" name="username"/>
    <input type="password" placeholder="كلمه المرور" name="password"/>
    <input type="submit"  name="submit" value="تسجيل دخول" />
    <!-- <p class="message">ليس لديك حساب ؟ <a href="#">انشاء حساب</a></p> -->
  </form>
