...
?>
    ...
    <tr>
      <td colspan="2"><b><?php echo $row['f_name'];?></b></td>
...
<tr height="50">
     ...
     <tr height="50">
      ...
      { echo "<div class='btn btn-success'>نشط</div>";
} else{
  echo "<div class='btn btn-danger'>Block</div>";
    ...
    <tr>
      ...
      <td colspan="2">   
      <input name="Submit2" type="submit" class="btn btn-danger" value="اغلاق هذه النافذه" onClick="return f2();" style="cursor: pointer;"  /></td>
    </tr>
