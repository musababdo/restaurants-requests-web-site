                            ...
                            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 profile-desc">
                                <div class="pull-left right-text white-txt">
                                    ...
                                    <ul class="nav nav-inline">
                                        <li class="nav-item"> <a class="nav-link active" href="#"><i class="fa fa-check"></i> Min SDG 10,00</a> </li>
...
?>									
                                        ...
                                        <div class="form-group row no-gutter">
                                            <div class="col-xs-8">
                                                 <input type="text" class="form-control b-r-0" value=<?php echo "SDG".$item["price"]; ?> readonly id="exampleSelect1">
...
?>								  
                                ...
                                <div class="widget-body">
                                    <div class="price-wrap text-xs-center">
                                        <p>المجموع</p>
                                        <h3 class="value"><strong><?php echo "SDG ".$item_total; ?></strong></h3>
                                        <p>الشحن مجانا</p>
                                        <a href="checkout.php?res_id=<?php echo $_GET['res_id'];?>&action=check"  class="btn theme-btn btn-lg">الدفع</a>
                                    </div>
                                </div>
                    ...
                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-6">
                        ...
                        <div class="menu-widget" id="2">
                            <div class="widget-heading">
                                <h3 class="widget-title text-dark">
                                الطلبات الشعبية طعام ساخن لذيذ! <a class="btn btn-link pull-right" data-toggle="collapse" href="#popular2" aria-expanded="true">
						...
						<?php  // display values and item of food/dishes
                                ...
                                <div class="food-item">
                                    <div class="row">
										...
										<span class="price pull-left" >SDG <?php echo $product['price']; ?></span>
										  <input class="b-r-0" type="text" name="quantity"  style="margin-left:30px;" value="1" size="2" />
										  <input type="submit" class="btn theme-btn" style="margin-left:40px;" value="أضف الي السله" />
										</div>
										</form>
                                    </div>
                                    <!-- end:row -->
